...
// This file is completely self-contained and can be copied to any Xcode project
// Only requirement: Add the Muscles-simplified.svg to your asset catalog
...
struct MuscleGroupMapping {
    ...
    static let appToSvgMapping: [String: [String]] = {
    ...
    static func svgIds(for muscleGroup: String) -> [String] {
        return appToSvgMapping[muscleGroup] ?? []
    }

    static func appMuscleGroup(for svgId: String) -> String? {
        return svgToAppMapping[svgId]
    }
}

// MARK: - Main View
struct StandaloneBodyHeatmap: View {
